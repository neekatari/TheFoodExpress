...
import '../Shop_Owner_basics/Owner_images/one.jpg'
import '../Shop_Owner_basics/Owner_images/two.jpg'
import '../Shop_Owner_basics/Owner_images/three.jpg'
                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={require("../Shop_Owner_basics/Owner_images/one.jpg")} alt="First slide" />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={require("../Shop_Owner_basics/Owner_images/two.jpg")} alt="Second slide" />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={require("../Shop_Owner_basics/Owner_images/three.jpg")} alt="Third slide" />
                                    </div>
                                </div>
                            </div>
